...
app.get('/Alertas', (req, res) => {
    res.sendFile(path.join(__dirname, '../frontend/html/alertas.html'));
});

app.get('/Estoque', (req, res) => {
    res.sendFile(path.join(__dirname, '../frontend/html/estoque.html'));
});

// Ensure all routes fallback to index.html for SPA behavior
app.get("/", (req, res) => {
    res.sendFile(path.join(__dirname, '../frontend/html/index.html'));
});
...
app.post("/produtos", async (req, res) => {
    ...
    try {
        console.log("Executing query:", cadastrar);
        console.log("With values:", [nome, marca, volume, tipo_embalagem, aplicacao, estoque, estoque_minimo]);
        ...
        res.json({ msg: "Cadastro não efetuado", error: error.message });
    }
});
